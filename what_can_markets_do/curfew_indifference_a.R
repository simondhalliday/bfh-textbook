...
library(shape)
pdf(file = "what_can_markets_do/curfew_indifference_a.pdf", width = 10, height = 8)
...
text(6, -13, expression(paste("Curfew, T")), xpd = TRUE, cex = axislabelsize, srt = 0) 
#text(, side = 1, line = 2, cex = axislabelsize)
text(xlims[1] - 0.7, 0, expression(paste("Difference in income, ", y^A)), xpd = TRUE, cex = axislabelsize, srt = 90) 
...
text(3.8, 9, expression(paste("Better for A")), 
...
text(9.3, 5, expression(paste( u[1]^A == -18 )), xpd = TRUE, cex = labelsize)
text(7.8, 5, expression(paste( u[2]^A == -9)), xpd = TRUE, cex = labelsize)
text(5.7, 5, expression(paste( u[3]^A == 0)), xpd = TRUE, cex = labelsize)
...
text(7.25, -12.5, expression(paste("Later")), 
     xpd = TRUE, cex = axislabelsize )
