require(shape)
pdf(file = "what_can_markets_do/sequential_coase_unrestricted_solved.pdf", width = 9, height = 7)
...
text(6, .6, expression("(" * phantom("4") * "," * phantom("4") * ")"), col = rgb(0, 0, 0, fadelevel), cex = actionlabelsize)
