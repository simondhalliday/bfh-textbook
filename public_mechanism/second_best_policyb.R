...
library(shape)
pdf(file = "public_mechanism/second_best_policyb.pdf", width = 9, height = 7)
...
#Monopoly CS no MSC: 
xpolyCSM <- c(monopoly[1], 0, 0, monopoly[1])
ypolyCSM <- c(AvgRevenue(x = monopoly[1]), 12, AvgRevenue(x = monopoly[1]), AvgRevenue(x = monopoly[1]))
...
#Total costs covering social costs 
xpolya <- c(monopoly[2], monopoly[2], 0, 0, monopoly[2])
...
text(3.5, 7.95, expression(B), cex = labelsize)
...
text(1.35, 5.25, expression(paste("Green tax only:")), cex = labelsize)
text(1.35, 4.75, expression(paste("monopoly pays")), cex = labelsize)
text(1.35, 4.25, expression(paste("tax covering")), cex = labelsize)
text(1.35, 3.75, expression(paste("external costs")), cex = labelsize)
