...
text(6, .6, expression(phantom("(") * "0" * phantom(",") * phantom("0") * phantom(")")), col = rgb(0, 0, 1, 1),  cex = actionlabelsize)
text(6, .6, expression(phantom("(") * phantom("0") * phantom(",") * "0" * phantom(")")), col = rgb(1, 0, 0, 1), cex = actionlabelsize)

text(9, .6, expression("(" * phantom("2") * "," * phantom("4") * ")"), cex = actionlabelsize)
text(9, .6, expression(phantom("(") * "2" * phantom(",") * phantom("4") * phantom(")")), col = rgb(0, 0, 1, 1),  cex = actionlabelsize)
text(9, .6, expression(phantom("(") * phantom("2") * phantom(",") * "4" * phantom(")")), col = rgb(1, 0, 0, 1), cex = actionlabelsize)
