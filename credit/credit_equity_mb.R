...
text(-0.12, 0.5*(ylims[2] + ylims[1]), expression(paste("Discount factor, ", delta )), xpd = TRUE, cex = axislabelsize, srt = 90) 
...
segments(0, mc(f = 1), xlims[2], mc(f = 1), lty = 1, col = "gray" , lwd = segmentlinewidth)
