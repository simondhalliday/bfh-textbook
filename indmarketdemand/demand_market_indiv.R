require(shape)
pdf(file = "bfh-textbook/indmarketdemand/demand_market_indiv.pdf", width = 9, height = 7)
...
#Label mrs function
text(28, 6.8, expression(paste("Demand: ", x(p) == 20 - 2*p)))
text(28, 5.5, expression(paste("Inverse Demand: ", p(x) == 10 - frac(1,2)*x)))
