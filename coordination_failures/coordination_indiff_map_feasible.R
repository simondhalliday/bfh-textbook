require(shape)
pdf(file = "coordination_failures/coordination_indiff_map_feasible.pdf", width = 9, height = 7)
...
text(-1.75, 10, expression(paste("B's hours,", h^B)), xpd = TRUE, cex = axislabelsize, srt = 90) 
...
# segments(13,  brfA(13) - 2,  13,  brfA(13), lty = 2, col = Grays[18], lwd = segmentlinewidth)
...
# segments(11, brfA(11) - 2, 11, brfA(11), lty = 2, col = Grays[18], lwd = segmentlinewidth)
...
# Arrows(11, 18.5, 11, 17.5, col = "black", lty = 1, lwd = 2, arr.type = "triangle", arr.lwd = 0.5)
