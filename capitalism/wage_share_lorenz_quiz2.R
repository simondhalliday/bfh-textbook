...
library(shape)
library(pBrackets)
#pdf(file = "capitalism/wage_share_lorenz_quiz.pdf", width = 10, height = 8)
jpeg(file = "capitalism/wage_share_lorenz_quiz2.jpg", width = 6*120, height = 5*120)
...
ylabels <- c(0, expression(paste(0.60)), expression(paste(gamma == 1)))
ticksx <- c(xlims[1], xvec[3], xlims[2])

xlabels <- c(60, round(xlab[3],0),  90)
ticksy2 <- c(0,1)
...
#text(xvec[2] - 0.005, 0.63, expression(paste(n)), cex = labelsize)
#text(xvec[2] -0.01, WageFn(xvec[2], ubar = ulow)+0.01, expression(paste(c)), cex = labelsize)
text(xvec[3] + 0.01, 0.57, expression(paste(n[2])), cex = labelsize)

#text(0.74, 0.45, expression(paste("Original")), cex = labelsize)
text(0.78, 0.37, expression(paste("Wage")), cex = labelsize)
text(0.78, 0.32, expression(paste("curve, ", w[2]^N )), cex = labelsize)
...
text(0.65, 0.68, expression(paste("Competition")), cex = labelsize)
text(0.65, 0.63, expression(paste("condition, ", w^c)), cex = labelsize)
