...
text(4.25, 7.25, expression(a))

#For production technique b
points(7.5, 4.5, pch = 16, col = "black", cex = 1.5)
text(7.25, 4.25, expression(b))


text(8, 8, expression(paste("Choice between")), cex = labelsize)
...
text(2, 3, expression(paste("Infeasible")), cex = labelsize)
text(2, 2.5, expression(paste("production")), cex = labelsize)
text(2, 2, expression(paste("techniques")), cex = labelsize)
