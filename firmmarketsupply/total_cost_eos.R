...
require(shape)
pdf(file = "firmmarketsupply/total_cost_eos.pdf", width = 9, height = 7)
...
#Average Cost
text(2.5, 10, expression(paste("Slope of ray from origin")), cex = labelsize)
text(2.5, 9.4, expression(paste("equals Average Cost")), cex = labelsize)
Arrows(2, 9, 2, 1.8, col = "black", lty = 1, lwd = 2, arr.type = "triangle", arr.lwd = 0.5)

#Marginal Cost
text(12, totalcost(x = 4, c0 = 2, c1 = 0.05, c2 = 0.05) + 0.3, expression(paste("Slope of tangent line")), cex = labelsize)
text(12, totalcost(x = 4, c0 = 2, c1 = 0.05, c2 = 0.05) - 0.3, expression(paste("equals Marginal Cost")), cex = labelsize)
