require(shape)
#pdf(file = "competitionmarkets/barriers_exam_nolabels.pdf", width = 9, height = 7)
jpeg(file = "barriers_exam_nolabels.jpg", width = 6*120, height = 4*120)
...
ylabels <- c(NA, expression(c), NA, NA, NA)
