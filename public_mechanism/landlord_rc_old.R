...
# 
points(28.226, 6, pch = 16, col = "black", cex = 1.5)
text(28.226 + 1.5, 6 - 0.5, expression(r), cex = labelsize)

points(48.817 +18.226, 6, pch = 16, col = "black", cex = 1.5)
text(48.817 +18.226 - 1.5, 6 - 0.5, expression(e), cex = labelsize)
