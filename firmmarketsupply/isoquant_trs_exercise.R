...
library(shape)
pdf(file = "constrained_optimization/indifference_exercise.pdf", width = 8, height = 6)
...
#Draw the graphs
lines(xx1, indiffA(xx1, alpha = 0.7, uA = 4), col = COLA[5], lwd = graphlinewidth)
...
#Axis labels
mtext(expression(paste("Cups of tea, ", x)), side = 1, line = 2.5, cex = axislabelsize)
text(-0.8, 5, expression(paste("Plates of Cookies, ", y)), xpd = TRUE, cex = axislabelsize, srt = 90) 
...
text(2.9705 + 0.2, indiffA(x = 2.9705) + 0.2, expression(paste(a)), cex = labelsize)
points(2.9705, indiffA(x = 2.9705), pch = 16, col = "black", cex = 1.5)

text(8 - 0.2, indiffA(x = 8) - 0.2, expression(paste(c)), cex = labelsize)
points(8, indiffA(x = 8), pch = 16, col = "black", cex = 1.5)


text(8 - 0.2, indiffA(x = 8, alpha = 0.5) - 0.2, expression(paste(e)), cex = labelsize)
points(8, indiffA(x = 8, alpha = 0.5), pch = 16, col = "black", cex = 1.5)

text(2 + 0.2, indiffA(x = 2, alpha = 0.5) + 0.2, expression(paste(d)), cex = labelsize)
points(2, indiffA(x = 2, alpha = 0.5), pch = 16, col = "black", cex = 1.5)
