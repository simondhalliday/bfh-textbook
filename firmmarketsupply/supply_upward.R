...
require(shape)
pdf(file = "firmmarketsupply/supply_upward.pdf", width = 9, height = 7)
...
ticksy <- c(0, 2, MCost(x = 3.4641), ylims[2])
ylabels <- c(NA, expression(paste(c[0])), expression(paste(p[min])), NA)
ticksx <- c(0, 3.4641, xlims[2])
xlabels <- c(NA, expression(paste(x[min])), NA)
...
xx2 <- seq(0, 3.4641, length.out = npts)
xx4 <- seq(3.4641, xlims[2], length.out = npts)
...
#lines(xx1, AvgVarCost(xx1, c1 = 2, c2 = 0.5), col = COLA[5], lwd = graphlinewidth)
lines(xx4, MCost(xx4, c1 = 2, c2 = 0.5), col = COLA[4], lwd = graphlinewidth)
lines(xx2, MCost(xx2, c1 = 2, c2 = 0.5), col = COLA[4], lwd = graphlinewidth, lty = 2)
...
#Label curves
text(10.5, 8.4, expression(paste(ac(x))), cex = labelsize)
text(10.5, 11.6, expression(paste(mc(x))), cex = labelsize)
#text(10.5, 6.6, expression(paste(avc(x))), cex = labelsize)

text(5, 8.9, expression(paste("Firm's Supply Curve")), cex = labelsize)
...
segments(0, MCost(x = 3.4641), 3.4641, MCost(x = 3.4641), lty = 2, col = "gray" , lwd = segmentlinewidth)
segments(3.4641, 0, 3.4641, MCost(x = 3.4641), lty = 2, col = "gray" , lwd = segmentlinewidth)
...
points(3.4641, MCost(x = 3.4641), pch = 16, col = "black", cex = 1.5)
