require(ggplot2)
require(shape)
pdf(file = "people/matrix_pgg.pdf", width = 9, height = 7)
...
P1Name <- c("Abdul")
P1Strat <- c("Contribute", "Don't")
P1Payoffs <- c("20", "25", "5", "10")
...
P2Name <- c("Everyone Else")
P2Strat <- c("Contribute", "Don't")
P2Payoffs <- c("20", "10", "25", "10")
