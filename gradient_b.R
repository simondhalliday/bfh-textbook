...
library(shape)
library(pBrackets)
pdf(file = "mathappendix/gradient_b.pdf", width = 8, height = 6)
...
# brackets
#brackets(36.5, 5.9, 25.5, 3.1, h = NULL, ticks = 0.5, curvature = 0.5, type = 1, col = 1, lwd = 1, lty = 1, xpd = FALSE)
...
brackets(24.5, 2.8, 9.5, 2.8, h = .4, ticks = 0.5, curvature = 0.5, type = 1, col = 1, lwd = 1, lty = 1, xpd = FALSE)
