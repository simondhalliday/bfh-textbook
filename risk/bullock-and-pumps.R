...
braces(deltaA, deltaA + 0.2, yA, yAprime, 1/4, mid = 9 / (yA + yAprime))
braces(deltaB, deltaB - 0.2, yB, yBprime, 1/4, mid = 9 / (yB + yBprime))
braces(deltaB, deltaB - 0.2, yA, yB, 0.5)
Arrows(2.3, 9, 1.4, 9, col = "black", lty = 1, lwd = 2, code = 2, arr.type = "triangle", arr.lwd = 0.5)
Arrows(3.7, 9, 4.6, 9, col = "black", lty = 1, lwd = 2, code = 2, arr.type = "triangle", arr.lwd = 0.5)
...
text((deltaA + deltaB)/2, 9, 'Non Farm Income', cex = labelsize)
