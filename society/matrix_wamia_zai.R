require(ggplot2)
require(shape)
pdf(file = "society/matrix_wamia_zai.pdf", width = 9, height = 7)
...
P1Name <- c("Wamia's Wellness")
P1Strat <- c("Online", "Brick &")
P1Strat2 <- c("App", "Mortar")
P1Payoffs <- c("1", "3", "5", "2")
...
P2Name <- c("Zai's Zen")
P2Strat <- c("Online", "Brick &")
P2Strat2 <- c("App", "Mortar")
P2Payoffs <- c("1", "5", "3", "2")
