...
text(0.2, 1, expression(paste(y[1])), cex = labelsize)
text(0.2, 0.88, expression(paste(y[2])), cex = labelsize)
text(0.2, 0.78, expression(paste(y[3])), cex = labelsize)
text(0.6, 0.22, expression(Slope), cex = labelsize)
text(0.75, 0.14, expression(paste(-mrs(delta, f) == frac(1 - f, q*(1 - 2*f) + delta))), cex = labelsize)
Arrows(0.6, 0.24, 0.6, 0.65, col = "black", lty = 1, lwd = 2, arr.type = "triangle", arr.lwd = 0.5)
