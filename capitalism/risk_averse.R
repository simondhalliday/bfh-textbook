...
text(-2, 0.5*ylims[2], expression(paste("Utility of income, u(y)")), xpd = TRUE, cex = axislabelsize, srt = 90) 
...
#Very risk averse
text(7, ConcaveU(5)-4, expression(paste("very risk")),  xpd = TRUE,  cex = labelsize)
text(7, ConcaveU(5)-6, expression(paste("averse")),  xpd = TRUE,  cex = labelsize)
#Risk averse
text(18, ConcaveU(18)-2, expression(paste("risk")),  xpd = TRUE,  cex = labelsize)
text(18, ConcaveU(18)-4, expression(paste("averse")),  xpd = TRUE,  cex = labelsize)
#Risk neutral
text(33, ConcaveU(33)-1.5, expression(paste("risk")),  xpd = TRUE,  cex = labelsize)
text(33, ConcaveU(33)-3.5, expression(paste("neutral")),  xpd = TRUE,  cex = labelsize)
