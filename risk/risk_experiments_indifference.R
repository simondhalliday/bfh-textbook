...
pdf(file = "risk/risk_experiments_indifference.pdf", width = 9, height = 7)
...
#Low
lines(xx1, indiffA(xx1, intercept = 19, slope = 0.00235), col = COLB[4], lwd = graphlinewidth, lty = 1)
#high
lines(xx1, indiffA(xx1, intercept = 23, slope = 0.00235), col = COLB[4], lwd = graphlinewidth, lty = 1)
