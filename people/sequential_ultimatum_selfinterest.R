...
text(6, .6, expression(phantom("(") * "5" * phantom(",") * phantom("5") * phantom(")")), col = rgb(0, 0, 1, 1,fadelevel),  cex = actionlabelsize)
text(6, .6, expression(phantom("(") * phantom("5") * phantom(",") * "5" * phantom(")")), col = rgb(1, 0, 0, 1,fadelevel), cex = actionlabelsize)
