...
jpeg(file = "capitalism/lorenz_wage_quiz2.jpg", width = 6*120, height = 5*120)
...
ticksx <- c(xlims[1], 0.04, 0.9, xlims[2])
xlabels <- c(NA, 4, 90,  100)
ticksy2 <- c(0,1)
...
# Lorenz curve
segments(0, 0, 0.04, 0, lty = 1, col = COLA[4], lwd = graphlinewidth, xpd = TRUE)
segments(0.04, 0, 0.9, 0.6, lty = 1, col = COLA[4], lwd = graphlinewidth)
