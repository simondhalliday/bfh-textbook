...
lines(xx1, indiffA(xx1, intercept = 23, slope = 0.0013), col = COL[2], lwd = graphlinewidth, lty = 1)
#Low
lines(xx1, indiffA(xx1, intercept = 20, slope = 0.0013), col = COL[2], lwd = graphlinewidth, lty = 1)
#high
lines(xx1, indiffA(xx1, intercept = 25, slope = 0.0013), col = COL[2], lwd = graphlinewidth, lty = 1)
...
text(35, 27, expression(u[3]^M), cex = labelsize)

text(52.5, 27, expression(u[2]^M), cex = labelsize)
text(52.5, 24, expression(u[1]^M), cex = labelsize)
