...
text(10, 207.7, expression("Pareto-efficient"), cex = annotatesize)
text(10, 190, expression("curve"), cex = annotatesize)
...
text(14, 25, expression(u[1]^A), cex = annotatesize)
text(14, 280, expression(u[2]^A), cex = annotatesize)

#Label the indifference curves for B
text(2, 380, expression(u[1]^B), cex = annotatesize)
