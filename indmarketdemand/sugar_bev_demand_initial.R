...
text(0.5*xlims[2], -0.25, expression(paste("Liters of sugary drinks, ", x)), xpd = TRUE, cex = axislabelsize) 
...
# Segments
segments(xprices[1], 0, xprices[1], prices[1], lty = 2, col = Grays[20] , lwd = segmentlinewidth)
