require(ggplot2)
require(shape)
pdf(file = "society/matrix_disagreement_check2.pdf", width = 9, height = 7)
...
P1Name <- c("Aisha")
P1Strat <- c("Don't learn", "Learn more")
P1Strat2 <- c("more English", "English")
P1Payoffs <- c("4", "1", "0", "2")
...
P2Name <- c("Ben")
P2Strat <- c("Learn more", "Don't learn")
P2Strat2 <- c("Swahili", "more Swahili")
P2Payoffs <- c("2", "0", "0", "4")
