...
Arrows((2/3)*xlims[2] + 2, 1, xlims[2] - 2.5, 1, col = "black", lty = 1, lwd = 2.5, arr.type = "triangle", xpd = TRUE)
Arrows((2/3)*xlims[2] - 8, 1, xlims[1] + 3.5, 1, col = "black", lty = 1, lwd = 2.5, arr.type = "triangle", xpd = TRUE)
