...
library(shape)
require(shape)
pdf(file = "/Users/rileyboeth/Library/Mobile Documents/com~apple~CloudDocs/bfh textbook - backup/coordination_failures/figure4_7b.pdf", width = 10, height = 8)
...
lines(xx1, indiffA1(xx1, uA= 8.3), col = COLA[4], lwd = graphlinewidth)
lines(xx1, indiffA1(xx1, uA = 16), col = COLA[4], lwd = graphlinewidth)
lines(xx1, indiffA1(xx1, uA = 23.7), col = COLA[4], lwd = graphlinewidth)
...
Arrows(-1, avgwealth(23)+11, -1, avgwealth(23)+1, col = "black", code =3, arr.type = "simple",xpd = TRUE)
Arrows(-1, avgwealth(23)-11, -1, avgwealth(23)-1, col = "black", code = 3, arr.type = "simple",xpd = TRUE)
