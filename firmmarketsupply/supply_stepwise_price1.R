...
prices <- c(2.6, 3.5)
#smoothed line
#segments(shares[1], costs[1] - 0.1, shares[7], costs[6] + 0.25, lty = 1, col = CBCols[2] , lwd = segmentlinewidth)
...
#Line for Supply
##Firm i
segments(shares[1], costs[1], shares[2], costs[1], lty = 1, col = CBCols[2] , lwd = segmentlinewidth)
segments(shares[2], costs[1], shares[2], costs[2], lty = 1, col = CBCols[2] , lwd = segmentlinewidth)
text((shares[1] + shares[2])/2, costs[1] - 0.15, expression("Firm I"), cex = labelsize)

##Firm 2
segments(shares[2], costs[2], shares[3], costs[2], lty = 1, col = CBCols[2] , lwd = segmentlinewidth)
segments(shares[3], costs[2], shares[3], costs[3], lty = 1, col = CBCols[2] , lwd = segmentlinewidth)
text((shares[2] + shares[3])/2, costs[2] - 0.15, expression("Firm J"), cex = labelsize)

##Firm 3
segments(shares[3], costs[3], shares[4], costs[3], lty = 1, col = CBCols[2] , lwd = segmentlinewidth)
segments(shares[4], costs[3], shares[4], costs[4], lty = 1, col = CBCols[2] , lwd = segmentlinewidth)
text((shares[3] + shares[4])/2, costs[3] - 0.15, expression("Firm K"), cex = labelsize)

##Firm 4
segments(shares[4], costs[4], shares[5], costs[4], lty = 1, col = CBCols[2] , lwd = segmentlinewidth)
segments(shares[5], costs[4], shares[5], costs[5], lty = 1, col = CBCols[2] , lwd = segmentlinewidth)
text((shares[4] + shares[5])/2, costs[4] - 0.15, expression("Firm L"), cex = labelsize)

##Firm 5
segments(shares[5], costs[5], shares[6], costs[5], lty = 1, col = CBCols[2] , lwd = segmentlinewidth)
segments(shares[6], costs[5], shares[6], costs[6], lty = 1, col = CBCols[2] , lwd = segmentlinewidth)
text((shares[5] + shares[6])/2, costs[5] - 0.15, expression("Firm M"), cex = labelsize)

##Firm 6
segments(shares[6], costs[6], shares[7], costs[6], lty = 1, col = CBCols[2] , lwd = segmentlinewidth)
segments(shares[7], costs[6], shares[7], costs[7], lty = 1, col = CBCols[2] , lwd = segmentlinewidth, xpd = TRUE)
...
#horizontal lines
#price line
segments(0, prices[1], xlims[2], prices[1], lty = 1, col = CBCols[1], lwd = graphlinewidth)
