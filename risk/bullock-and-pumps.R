...
braces(deltaA, deltaA + 0.2, yA, yAprime, 1/4)
braces(deltaB, deltaB - 0.2, yB, yBprime, 1/4)
braces(deltaB, deltaB - 0.2, yA, yB, 1/4)
Arrows(2.3, 9, 1.4, 8, col = "black", lty = 1, lwd = 2, code = 2, arr.type = "triangle", arr.lwd = 0.5)
Arrows(3.7, 10, 4.6, 11, col = "black", lty = 1, lwd = 2, code = 2, arr.type = "triangle", arr.lwd = 0.5)
Arrows(4.7, 4.5, 4, 3, col = "black", lty = 1, lwd = 2, code = 2, arr.type = "triangle", arr.lwd = 0.5)
                                        # the four points
...
text(deltaB-1.5, 2.3, 'Increased Expected Income\n from Pumps', cex = labelsize)
dev.off()
