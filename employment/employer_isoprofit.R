require(ggplot2)
require(shape)
pdf(file = "employment/employer_isoprofit.pdf", width = 9, height = 7)
...
text(-4, ylims[2] - 0.5*(ylims[2] - ylims[1]), expression(paste("Effort, ", e)), xpd = TRUE, cex = axislabelsize, srt = 90) 
...
segments(10, 0, 10, 0.5, lty = 2, col = grays[20])

#Add a point for the NE
points(20, 0.5, pch = 16, col = "black", cex = 1.5)
text(20 + 0.5, 0.5 - 0.025, expression(paste(d)), cex = labelsize)

points(10, 0.5, pch = 16, col = "black", cex = 1.5)
text(10 + 0.5, 0.5 - 0.025, expression(paste(c)), cex = labelsize)

points(10, 0.25, pch = 16, col = "black", cex = 1.5)
text(10 + 0.5, 0.25  - 0.025, expression(paste(b)), cex = labelsize)

points(10, 0.125, pch = 16, col = "black", cex = 1.5)
text(10 + 0.5, 0.125 - 0.025, expression(paste(a)), cex = labelsize)
