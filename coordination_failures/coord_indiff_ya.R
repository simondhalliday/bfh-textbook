...
ticksy <- c(0, 1, 10, 12.3, 28, 28.2, 46.08, 70)
...
segments(0, 12.3, 2, 12.3, ylims[2], lty = 2, col = "gray" , lwd = segmentlinewidth)
segments(0, 28.2, 6, 28.2, ylims[2], lty = 2, col = "gray" , lwd = segmentlinewidth)
