...
library(extrafont)
library(pBrackets)
pdf(file = "random/bertrand_unit.pdf", width = 6, height = 3.5)
...
text(5, 1.4, expression(paste("Demand for Pixels")), 
...
text(1.4, 1.4, expression(paste("When ",  Delta*p == p[2] - p[1], phantom() > 0)), 
     xpd = TRUE, srt = 0, cex = annotatesize)
