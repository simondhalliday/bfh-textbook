require(shape)
pdf(file = "bfh-textbook/indmarketdemand/demand_qql_indiff.pdf", width = 9, height = 7)
...
ticksy <- c(0, 6, 12, 13, 15, 17, ylims[2])
ylabels <- c(NA, expression(paste(y,"*")), expression(paste(y == m)), expression(paste(y == u[1])), expression(paste(y == u[2])), expression(paste(y == u[3])), NA)
