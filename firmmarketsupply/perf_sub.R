...
pdf(file = "firmmarketsupply/perf_sub.pdf", width = 9, height = 7)
...
ticksy <- c(0, 5.5, ylims[2])
ylabels <- c(NA, expression(paste(k[1])), NA)
ticksx <- c(0, 5.5, xlims[2])
...
segments(1, 10, 10, 1, lty = 1, col = COLB[5], lwd = graphlinewidth)
#segments(4, 6, 1, ylims[2], lty = 1, col = COLA[3],  lwd = graphlinewidth)
...
points(5.5, 5.5, pch = 16, col = "black", cex = 1.5)
text(5.25, 5.25, expression(i))
