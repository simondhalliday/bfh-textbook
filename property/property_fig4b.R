...
require(shape)
require(plotrix)
pdf(file = "bfh-textbook/property/property_fig4b.pdf", width = 9, height = 7)
...
#Aisha's
text(11, 4.4, expression(paste("Aisha's Utility at ", u[2]^A)))

#Betty's
text(6.4, 12.5, expression(paste("Betty's Utility at ", u[2]^B)))
