...
text(6, .6, expression("(" * phantom("0") * "," * phantom("0") * ")"), cex = actionlabelsize, col = rgb(0,0,0,fadelevel))
text(6, .6, expression(phantom("(") * "0" * phantom(",") * phantom("0") * phantom(")")), col = rgb(0, 0, 1, 1,fadelevel),  cex = actionlabelsize)
text(6, .6, expression(phantom("(") * phantom("0") * phantom(",") * "0" * phantom(")")), col = rgb(1, 0, 0, 1,fadelevel), cex = actionlabelsize)
