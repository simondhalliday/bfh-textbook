...
jpeg(file = "information_power/agent_rents_jpeg.jpg", width = 5*120, height = 4*120)
...
lines(xx1, disutilityFn(xx1, cbar = 1.3), col = CBCols[1], lwd = graphlinewidth)
lines(xx1, disutilityFn(xx1, underbarc = 1.1), col = CBCols[1], lwd = graphlinewidth)
#lines(xx1, disutilityFn(xx1, cbar = 1.1), col = CBCols[1], lwd = graphlinewidth)
...
#Segments
segments(0, 0.8, 1.05, 0.8, lty = 2, lwd = 1.5, col = grays[20], xpd = TRUE)
...
#Text annotations
text(0.125, 1, expression(paste(p[1]^N)), cex = labelsize, xpd = TRUE)
text(0.235, 1, expression(paste(p[2]^N)), cex = labelsize, xpd = TRUE)
text(0.335, 1, expression(paste(p[3]^N)), cex = labelsize, xpd = TRUE)
