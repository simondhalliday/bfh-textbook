...
pdf(file = "random/bertrand_unit_base.pdf", width = 6, height = 3.5)
...
#      xpd = TRUE, srt = 0, cex = labelsize)
text(2.6, 0.88, labels=emoji("neutral_face"), family="OpenSansEmoji", cex=2.9)

brackets(x1 = 3, y1 = 1.03, x2 = 6, y2 = 1.03,  
         ticks = 0.5, curvature = 0.5, type = 1, 
         col = "black", lwd = 2, lty = 1, xpd = TRUE)
text(4.5, 1.2, expression(paste("Demand for Pixels")), 
...
brackets(x1 = 3, y1 = 0.83, x2 = 0, y2 = 0.83,  
         ticks = 0.5, curvature = 0.5, type = 1, 
         col = "black", lwd = 2, lty = 1, xpd = TRUE)
text(1.5, 0.67, expression(paste("Demand for iPhones")), 
     xpd = TRUE, srt = 0, cex = annotatesize)
# text(2, 0.555, expression(paste(Q[1](p[1],p[2]) == frac(1,2) + Delta*p)), 
#      xpd = TRUE, srt = 0, cex = annotatesize)


text(2.7, 1.48, expression(paste("When the prices of Pixels and iPhones are equal")), 
     xpd = TRUE, srt = 0, cex = annotatesize)
