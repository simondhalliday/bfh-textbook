#require(ggplot2)
require(shape)
pdf(file = "property/psp_offer_final_newz_initial.pdf", width = 9, height = 7)
...
a2 <- c(uAlog(9,1), uAlog(4.83, (3/2)*4.83),1.925)
...
text(9.7, 3.05, expression(u[w]^A), cex = labelsize)
...
text(8.45, 1, expression(paste(u[z]^B,", B's PC")), cex = annotatesize)
...
text(10 - 4.83, 15 - (3/2)*4.83 - 0.4, expression(w), cex = annotatesize)
