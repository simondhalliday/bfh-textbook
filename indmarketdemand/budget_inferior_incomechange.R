require(shape)
pdf(file = "indmarketdemand/budget_inferior_incomechange.pdf", width = 9, height = 7)
...
lines(xx1, bcA(xx1, w = 2.24), col = COLB[3], lwd = graphlinewidth)
