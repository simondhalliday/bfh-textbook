...
library(pBrackets)
require(plotrix)
jpeg(file = "employment/completeness_rents_quiz.jpg", width = 6*120, height = 4.5*120)
...
lines(xx1, Incomp(xx1, j = 0.375), col = COL[1], lwd = graphlinewidth)
...
ticksy <- c(0, 1, Incomp(t = 0.5, j = 0.8), Incomp(t = 0.5, j = 0.375), Incomp(t = 0.5, j = 0.2), 4.5, 5)
ylabels <- c(0, expression(paste(B + underline(u))), 
             expression(paste(w[d])), 
             expression(paste(w[e])),
             expression(paste(w[f])), NA, NA)
#ticksx <-seq(0, 1, 0.1)
ticksx <- c(0, 0.5, 1)
#xlabels <-seq(0, 1, 0.1)
...
text(0.13, 5.3, expression(paste(A)), cex = labelsize, xpd = TRUE)
text(0.24, 5.3, expression(paste(B)), cex = labelsize, xpd = TRUE)
text(0.37, 5.3, expression(paste(C)), cex = labelsize, xpd = TRUE)
...
segments(0, Incomp(t = 0.5, j = 0.8), 1, Incomp(t = 0.5, j = 0.8) ,lty = 2, lwd = 1.5, col = "darkgray", xpd = TRUE)

segments(0, Incomp(t = 0.5, j = 0.375), 1, Incomp(t = 0.5, j = 0.375) ,lty = 2, lwd = 1.5, col = "darkgray", xpd = TRUE)

segments(0, Incomp(t = 0.5, j = 0.2), 1, Incomp(t = 0.5, j = 0.2) ,lty = 2, lwd = 1.5, col = "darkgray", xpd = TRUE)

points(0.5, Incomp(t = 0.5, j = 0.8), pch = 16, col = "black", cex = 1.5)
text(0.5 - 0.03, Incomp(t = 0.5, j = 0.8) - 0.15, expression(paste(d)), cex = labelsize, xpd = TRUE)

points(0.5, Incomp(t = 0.5, j = 0.375), pch = 16, col = "black", cex = 1.5)
text(0.5 - 0.03, Incomp(t = 0.5, j = 0.375) - 0.15, expression(paste(e)), cex = labelsize, xpd = TRUE)

points(0.5, Incomp(t = 0.5, j = 0.2), pch = 16, col = "black", cex = 1.5)
text(0.5 - 0.03, Incomp(t = 0.5, j = 0.2) - 0.15, expression(paste(f)), cex = labelsize, xpd = TRUE)

points(0.5, 1, pch = 16, col = "black", cex = 1.5)
text(0.5 - 0.03, 1 - 0.15, expression(paste(c)), cex = labelsize, xpd = TRUE)

points(0.5, 4.5, pch = 16, col = "black", cex = 1.5)
text(0.5 - 0.03, 4.5 - 0.15, expression(paste(g)), cex = labelsize, xpd = TRUE)
