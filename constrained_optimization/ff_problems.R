...
library(shape)
pdf(file = "constrained_optimization/ff_problems.pdf", width = 8, height = 8)
...
text(10.5, 4.4, expression(paste("Anna's")), cex = labelsize)
text(10.5, 4, expression(paste("Reservation")), cex = labelsize)
text(10.5, 3.6, expression(paste("Indifference")), cex = labelsize)
text(10.5, 3.2, expression(paste("Curve")), cex = labelsize)
Arrows(10.5, 4.6, 10.5, 8.4, col = "black", lty = 1, lwd = 2, arr.type = "triangle", arr.lwd = 0.5)
...
text(24, 5, expression(ic[3]), cex = labelsize, xpd = TRUE)
text(24, 7.4, expression(ic[4]), cex = labelsize, xpd = TRUE)
