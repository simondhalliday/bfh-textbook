...
require(plotrix)
require(pBrackets)
pdf(file = "capitalism/lewis_development_slide1.pdf", width = 9, height = 7)
...
ticksy <- c(0, wagelvls[1], NA, prodlvls, ylims[2])
ylabels <- c(0, expression(paste(w[1]^C)), NA, expression(paste(gamma[1])), expression(paste(gamma[2])), NA)
