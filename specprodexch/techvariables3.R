...
ticksx <- c(xlims[1], 1.665, 4.76,9.44 ,xlims[2])
...
#Draw the graphs
lines(xx1, isoA(xx1, alpha = 0.8, xbar = 3.5, A = 3), col = COLA[5], lwd = graphlinewidth)
lines(xx1, isoA(xx1, alpha = 0.8, xbar = 4.5, A = 2.3 ), col = COLA[5], lwd = graphlinewidth)
