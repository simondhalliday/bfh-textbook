...
# Text --------------------------------------------------------------------
text(9, 33.5, expression(bold("Government")), cex = labelsize)
...
text(43.5, 33.5, expression(bold("Markets")), cex = labelsize)
...
text(27, 11, expression(bold("Civil Society")), cex = labelsize)
...
Arrows(0.45*xlims[2], 35.5, 0.45*xlims[2], 39, code = 1, lty = 1, lwd = graphlinewidth, arr.type = "triangle", arr.length = 0.2, col = "black")

text(0.65*xlims[2], 41, expression("'Cap and trade'"), cex = labelsize, xpd = TRUE)
Arrows(0.6*xlims[2], 35.5, 0.6*xlims[2], 39, code = 1, lty = 1, lwd = graphlinewidth, arr.type = "triangle", arr.length = 0.2, col = "black")

# Right
text(41, 25, expression("Relationships within"), cex = labelsize, xpd = TRUE)
text(41, 23.4, expression("conventional firms"), cex = labelsize, xpd = TRUE)
Arrows(30, 22, 35, 23.5, code = 1, lty = 1, lwd = graphlinewidth, arr.type = "triangle", arr.length = 0.2, col = "black")

text(40, 19.5, expression("Open-sourced software"), cex = labelsize, xpd = TRUE)
Arrows(30, 20, 32.5, 19.5, code = 1, lty = 1, lwd = graphlinewidth, arr.type = "triangle", arr.length = 0.2, col = "black")
...
Arrows(26, 20, 31, 17, code = 1, lty = 1, lwd = graphlinewidth, arr.type = "triangle", arr.length = 0.2, col = "black")
...
Arrows(27, 16.5, 22, 14, code = 1, lty = 1, lwd = graphlinewidth, arr.type = "triangle", arr.length = 0.2, col = "black")
...
Arrows(24, 19, 20, 21.5, code = 1, lty = 1, lwd = graphlinewidth, arr.type = "triangle", arr.length = 0.2, col = "black")
