require(shape)
pdf(file = "indmarketdemand/qql_duncan_indiff.pdf", width = 9, height = 7)
...
text(-1.4, 0.5*ylims[2], expression(paste("Quanity of money, ", y)), xpd = TRUE, cex = axislabelsize, srt = 90) 
