...
require(shape)
pdf(file = "firmmarketsupply/isoprofit_MR_MC.pdf", width = 9, height = 7)
...
ylabels <- c(NA, expression(paste(c)), expression(paste(bar(p))))
...
#text(10.5, 4.5, expression(paste(mc(x))), cex = labelsize)
