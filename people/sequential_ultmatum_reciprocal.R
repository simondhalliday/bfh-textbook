require(shape)
pdf(file = "people/sequential_ultimatum_reciprocal.pdf", width = 9, height = 7)
...
#Branches for Aram
#Offer (8, 2)
segments(5, 9, 2.5, 5, lty = 1, col = rgb(0, 0, 1, fadelevel), lwd = graphlinewidth)
#Offer (5, 5)
...
segments(2.5, 5, 1, 1, lty = 1, col = rgb(1, 0, 0, fadelevel), lwd = graphlinewidth)
...
text(3.3, 7.5, expression(paste("Offer (8, 2)")), cex = actionlabelsize, col = rgb(0,0,0,fadelevel))
text(3.3, 7.1, expression(paste("split")), cex = actionlabelsize, col = rgb(0,0,0,fadelevel))
...
text(1, 3, expression(paste("Accept")), cex = actionlabelsize, col = rgb(0,0,0,fadelevel))
text(3.8, 3, expression(paste("Reject")), cex = actionlabelsize, col = rgb(0,0,0,fadelevel))
...
text(4, .6, expression(phantom("(") * phantom("0") * phantom(",") * "0" * phantom(")")), col = rgb(1, 0, 0, 0.5,fadelevel), cex = actionlabelsize)
