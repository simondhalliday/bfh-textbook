require(ggplot2)
require(shape)
pdf(file = "society/matrix_fishermen_inverted.pdf", width = 9, height = 7)
...
P1Name <- c("Alfredo")
P1Strat <- c("12 Hours", "10 Hours")
P1Strat2 <- c("(Defect)", "(Cooperate)")
P1Payoffs <- c("z", "x", "y", "w")
...
P2Name <- c("Bob")
P2Strat <- c("12 Hours", "12 Hours")
P2Strat2 <- c("(Defect)", "(Cooperate)")
P2Payoffs <- c("z", "y", "x", "w")
