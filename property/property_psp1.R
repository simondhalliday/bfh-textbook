#require(ggplot2)
require(shape)
# pdf(file = "property_psp1STEP1.pdf", width = 9, height = 7)
# pdf(file = "property_psp1STEP2.pdf", width = 9, height = 7)
# pdf(file = "property_psp1STEP3.pdf", width = 9, height = 7)
...
xpoly1 <- seq(from = 4, to = 10-3.623424, length.out = 500)
ypoly1 <- indiffcurveA3(xpoly1, U = 6.196918, A = 1, a = 0.5)
ypoly2 <- indiffcurveBneg2(xpoly1, U=5.703502, A = 1, a = 0.5)
...
text(9.6, 2.2, expression(u[1]^A==u[z]^A))
text(9.6, 4.4, expression(u[2]^A==u[m]^A))
...
Arrows(8.5, 10.3, 8.5, 12, col = "black", lty = 1, lwd = 2, arr.type = "triangle", arr.lwd = 0.5)
