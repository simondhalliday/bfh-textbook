...
Arrows(0.42, 16, 0.62, 16, col = "black", lty = 1, lwd = 2, arr.type = "triangle")
text(0.26, 17, expression(paste("Slope", phantom() == -u[q])), cex = labelsize)
text(0.34, 13, expression(paste(phantom() == frac(underline(u), (1-q)^2))), cex = labelsize)
