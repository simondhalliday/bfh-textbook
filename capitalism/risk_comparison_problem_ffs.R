require(shape)
library(pBrackets)
pdf(file = "capitalism/risk_comparison_problem_ffs.pdf", width = 9, height = 7)
...
ylabels <- c(NA, expression(paste(w^c)),   NA)
...
text(13.5, riskreturn(g = 14)+4, expression(paste("Low cost of")), cex = labelsize, xpd = TRUE)
text(13.5, riskreturn(g = 14)+3, expression(paste("capital R-RS")), cex = labelsize, xpd = TRUE)


text(14, riskreturn(int1 = 12, g = 14)-1.2, expression(paste(g(Delta) - bar(rho)%.%k) ), cex = labelsize, xpd = TRUE)
text(13.5, riskreturn(int1 = 12, g = 14)-2, expression(paste("High cost of")), cex = labelsize, xpd = TRUE)
text(13.5, riskreturn(int1 = 12, g = 14)-2.8, expression(paste("capital R-RS")), cex = labelsize, xpd = TRUE)
...
# text(7.25, riskreturn(int1 = 15, 7.25) + 0.6, expression(b), cex = labelsize)
# text(11.6, 17, expression(u[2]), cex = labelsize)
# text(10.1, 17, expression(u[3]), cex = labelsize)
