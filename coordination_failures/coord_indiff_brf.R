require(shape)
pdf(file = "coordination_failures/coord_indiff_brf.pdf", width = 9, height = 7)
...
lines(xx1, brfA(xx1, alpha = 30, beta = 1/2), col = COLA[4], lwd = graphlinewidth + 0.2)
...
text(-3.5, 9.25, expression(paste("B's hours,", h^B)), xpd = TRUE, cex = axislabelsize, srt = 90) 
