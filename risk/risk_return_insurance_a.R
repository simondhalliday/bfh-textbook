...
require(shape)
library(pBrackets)
pdf(file = "risk/risk_return_insurance_a.pdf", width = 9, height = 7)
...
segments(0, insurance(g = 1.6, intercept = 7.4), 5.6, insurance(g = 1.6, intercept = 7.4), lty = 2, col = "gray", lwd = segmentlinewidth)
segments(1.6, 0, 1.6, insurance(g = 1.6, intercept = 7.4), lty = 2, col = "gray", lwd = segmentlinewidth)
...
text(6.9, 8.7, expression(paste(p[s]%.%i==phantom())), xpd = TRUE, cex = labelsize)
text(8.2, 9, expression(paste("insurance")), xpd = TRUE, cex = labelsize)
text(8.2, 8.4, expression(paste("premium")), xpd = TRUE, cex = labelsize)
...
text(14, 11.7, expression(paste("insurance")), xpd = TRUE)
text(14, 11.1, expression(paste("contract")), xpd = TRUE)
...
text(3, 17.3, expression(paste("Insurance reduces")), xpd = TRUE)
text(3, 16.7, expression(paste("risk exposure")), xpd = TRUE)
text(3, 16.1, expression(paste("and increases,")), xpd = TRUE)
text(3, 15.5, expression(paste("but does not ")), xpd = TRUE)
text(3, 14.9, expression(paste("maximize, utility ")), xpd = TRUE)
...
text(8.5, 17, expression(u[2]), cex = labelsize)
