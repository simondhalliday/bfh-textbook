...
library(shape)
pdf(file = "risk/utilitarianism.pdf", width = 10, height = 8)
...
text(8, 38, expression(paste(-u[a]^B, ",-B's marginal utility")), xpd = TRUE, cex = labelsize)
text(32, 38, expression(paste("A's marginal utility, ", u[a]^A)),  xpd = TRUE, cex = labelsize)
