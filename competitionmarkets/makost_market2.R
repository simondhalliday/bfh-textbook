...
ylabels <- c(NA, expression(paste(c[1])), expression(paste(r[max]^B)), expression(paste(r[max]^A)), NA)
...
segments(1, 2, 2, 2, lty = 1, col = COLA[4] , lwd = segmentlinewidth)
segments(1, 2, 1, 3, lty = 1, col = COLA[4] , lwd = segmentlinewidth)
segments(2, 2, 2, 0, lty = 1, col = COLA[4] , lwd = segmentlinewidth)
