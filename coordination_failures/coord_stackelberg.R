...
brfB <- function(ea, alpha = 16, beta = 1/48) {
  alpha*(1 - beta*ea)
}

brfA <- function(ea, alpha = 16, beta = 1/48) {
  (alpha - ea)/(alpha * beta)
}
...
segments(13.71429, 0,  13.71429, 11.42857, lty = 2, col = "gray" , lwd = segmentlinewidth)
...
#segments(16, 0,  16, 8, lty = 1, col = COL[2] , lwd = graphlinewidth)
#segments( 0, 8,  16, 8, lty = 1, col = COL[2] , lwd = graphlinewidth)

lines(xx1, brfA(xx1, alpha = 16, beta = 1/48), col = COLA[4], lwd = graphlinewidth)
lines(xx1, brfB(xx1, alpha = 16, beta = 1/48), col = COLB[4], lwd = graphlinewidth)
