require(shape)
pdf(file = "competitionmarkets/demand_supply_core_exam3.pdf", width = 9, height = 7)
...
ylabels <- c(NA, expression(paste(p[1])), expression(paste(p[2])), NA, NA)
...
lines(xx1, Supply(xx1, c1 = 1.5, c2 = 0.06), col = COLB[5], lwd = graphlinewidth)
...
text(75 - 2, Demand(75) - 0.75, expression(paste(1)), cex = axislabelsize) 
...
text(64.5, Supply(64.5, c1 = 1.5, c2 = 0.06)+ 0.75, expression(paste(2)), cex = axislabelsize) 

points(64.5, Supply(64.5, c1 = 1.5, c2 = 0.06), pch = 16, col = "black", cex = 1.5)

#segments(4.11765, 6.17647, 5.88, 8.88, lty = 1, col = COL[2] , lwd = graphlinewidth)
text(126, 10.8, expression("Supply before"), cex = labelsize)
text(126, 18.2, expression("Supply after"), cex = labelsize)
