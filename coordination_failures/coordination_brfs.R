require(shape)
pdf(file = "bfh-textbook/coordination_failures/coord_brfs.pdf", width = 9, height = 7)
...
ticksy <- c(0, 9.6, 16, 24, 26)
ylabels <- c(NA, expression(paste(e^{BN})), expression(paste(alpha)), expression(paste(1/beta)), NA)
ticksx <- c(0, 9.6, 16, 24, 26)
xlabels <- c(NA, expression(paste(e^{AN})), expression(paste(alpha)), expression(paste(1/beta)), NA)
