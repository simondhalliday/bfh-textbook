...
library(shape)
pdf(file = "mathappendix/indifference_map.pdf", width = 8, height = 8)
...
#Axis labels
mtext(expression(paste("Quantity of good, ", x)), side = 1, line = 2.5, cex = axislabelsize)
text(-1.2, 0.5*ylims[2], expression(paste("Quantity of good ", y)), xpd = TRUE, cex = axislabelsize, srt = 90) 

#Label the indifference curves
text(17, 1, expression(u[1]), cex = labelsize)
text(17, 1.65, expression(u[2]), cex = labelsize)
text(17, 2.7, expression(u[3]), cex = labelsize)
