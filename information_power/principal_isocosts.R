require(ggplot2)
require(shape)
pdf(file = "information_power/principal_isocosts.pdf", width = 9, height = 7)
...
lines(xx2, solowCondition(xx2, delta = 5, slope = 4), col = CBCols[2], lwd = graphlinewidth)
lines(xx2, solowCondition(xx2, delta = 5), col = CBCols[2], lwd = graphlinewidth)
lines(xx2, solowCondition(xx2, delta = 5, slope = 16), col = CBCols[2], lwd = graphlinewidth)
