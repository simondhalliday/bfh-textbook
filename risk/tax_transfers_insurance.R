...
lines(xx1, indiff(xx1, intercept = 11, slope = 0.06), col = COLA[4], lwd = graphlinewidth, lty = 1)
...
points(8.74, 16.894, pch = 16, col = "black", cex = 1.5) # e
...
text(8.4, 17, expression(e), cex = labelsize)
...
text(.5, 11.75, expression(u[4]), cex = labelsize)
