...
library(shape)
pdf(file = "constrained_optimization/feasible_frontier_indiff_only.pdf", width = 8, height = 8)
...
# 
# 
# text(13.1-0.2, ppf(13.1) + 0.1, expression(paste(b)), cex = labelsize)
...
text(3, 4.1, expression("Higher"), cex = labelsize)
text(3, 3.9, expression("Utility"), cex = labelsize)

text(12, 1.7, expression("Lower"), cex = labelsize)
text(12, 1.5, expression("Utility"), cex = labelsize)
