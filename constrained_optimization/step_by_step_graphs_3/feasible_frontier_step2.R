...
library(shape)
pdf(file = "constrained_optimization/step_by_step_graphs_3/ff_indifference_step2.pdf", width = 8, height = 8)
...
text(5.5, 4, expression(paste("Feasible, but utility could be higher")), xpd = TRUE, cex = 1.1)
