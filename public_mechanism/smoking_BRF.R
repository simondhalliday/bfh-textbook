...
text(-0.3, 5, expression(paste(x[B0]^N)), xpd = TRUE, cex = axislabelsize)
text(2, -0.49, expression(paste(x[At]^{direct})) , xpd=TRUE, cex=axislabelsize)
text(5, -0.49, expression(paste(x[A0]^N)), xpd=TRUE, cex=axislabelsize )
text(1.25, -0.49, expression(paste(x[At]^N)), xpd=TRUE, cex=axislabelsize )
text(0.5*xlims[2], -2, expression(paste("A's smoking")), xpd = TRUE, cex = bigaxislabelsize) 
text(-0.75, 0.5*ylims[2], expression(paste("B's smoking ")), xpd = TRUE, cex = bigaxislabelsize, srt = 90) 
...
text(1.65, -1.2, expression(paste("Indirect")), cex = labelsize, xpd = TRUE)
text(1.65, -1.5, expression(paste("effects")), cex = labelsize, xpd = TRUE)

text(3.5, -1.2, expression(paste("Direct")), cex = labelsize, xpd = TRUE)
text(3.5, -1.5, expression(paste("effect")), cex = labelsize, xpd = TRUE)
