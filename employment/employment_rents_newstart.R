...
library(extrafont)
library(pBrackets)
pdf(file = "employment/employment_rents_newstart.pdf", width = 8, height = 6)
...
xlabels <- c(NA, expression("Week 2"), expression("Week 22"), NA)
...
text(0.28, 0.6, expression("Rent if employed"), cex = labelsize)
...
text(0.28, -0.15, expression(paste("Spell of unemployment, ", s == 20, " weeks")), cex = labelsize, xpd = TRUE)
