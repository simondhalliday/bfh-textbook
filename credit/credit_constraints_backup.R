...
library(tidyverse)
library(shape)
#pdf(file = "credit/credit_constraints_backup.pdf", width = 18, height = 6)
...
labels <- c("Fraction borrowing at credit card \n interest rates (between 16 and 20%)",
            "Unable to cover 3 months' expenses by \n  any means if primary income source lost", 
            "Unable to cover $400 expense with cash,\n savings, or credit card paid in a month", 
