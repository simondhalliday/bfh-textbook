...
COL <- c("#7fc97f", "#beaed4", "#fdc086", "#ffff99", "#386cb0", "#f0027f", "#bf5b17", "#666666", "#AA0A27")
...
text(7.2, 8, expression(paste("wage, ", w)), col = COL[9])
...
text(13.5, 12.5, expression(paste("termination")), col = COL[9])
text(13.5, 11.8, expression(paste("schedule, ", t == (1 - e))), col = COL[9])
...
text(19, 7, expression(paste("effort, ", e)), col = COLB[4])
