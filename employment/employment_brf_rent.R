...
ticksx <- c(0, 10, 20, 40)
xlabels <- c(0, expression(paste(underline(u))), expression(paste(w^N)) , NA)
...
text(8.3, 0.05, expression(paste(v[0] == z)), cex = labelsize)
...
text(12.5 - 0.5, isovhigh1(w = 12.5) + 0.025, expression(c),cex = labelsize)
