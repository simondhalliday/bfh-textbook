#Graph Designer(s): Simon Halliday, Riley Boeth '17,  Weikai Chen, Scott Cohn
...
pdf(file = "risk/bullock_pumps_b_points.pdf", width = 10, height = 8)
...
segments(deltaB, 0, deltaB, yBprime, lty = 2, col = grays[20] , lwd = segmentlinewidth)
