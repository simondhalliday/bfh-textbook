...
require(shape)
require(plotrix)
pdf(file = "property_fig6.pdf", width = 9, height = 7)
...
swf.e <- function(ub, a = 0.4, W = 4.41465) {
  (((W)*(1/ub)^a)^(1/(1-a)))
}


swf.f <- function(ub, a = 0.4, W = 6.246474) {
  (((W)*(1/ub)^a)^(1/(1-a)))
}


swf.g <- function(ub, a = 0.4, W = 5.344295) {
  (((W)*(1/ub)^a)^(1/(1-a)))
}

swf.i <- function(ub, a = 0.4, W = 6.123724) {
  (((W)*(1/ub)^a)^(1/(1-a)))
}
