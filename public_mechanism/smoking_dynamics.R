...
text(5.2, 4.9, expression(paste(a)), cex = labelsize)
text(6.7, 3.2, expression(paste("Nash Equilibrium")), cex = labelsize)
Arrows(6.8, 3.4, 5.5, 4.6, lty = 1, lwd = 2, arr.type = "triangle")
#text(4.75, 5.2, expression(paste("NE")), cex = labelsize)

#Arrows for dynamics
Arrows(0, 10/4, BRFXi(Xj = 10/4, P = 4) - 0.2, 10/4, col = COLB[4], lty = 1, lwd = 2, arr.type = "triangle")
Arrows(BRFXi(Xj = 10/4, P = 4), 10/4 + 0.2, BRFXi(Xj = 10/4, P = 4), BRFXi(Xj = BRFXi(Xj = 10/4, P = 4), P = 4) - 0.3, col = COLA[4], lty = 1, lwd = 2, arr.type = "triangle")
Arrows(BRFXi(Xj = 10/4, P = 4) + 0.1, BRFXi(Xj = BRFXi(Xj = 10/4, P = 4), P = 4), BRFXi(Xj = BRFXi(Xj = BRFXi(Xj = 10/4, P = 4), P = 4), P = 4) - 0.2, BRFXi(Xj = BRFXi(Xj = 10/4, P = 4), P = 4), col = COLB[4], lty = 1, lwd = 2, arr.type = "triangle")

points(BRFXi(Xj = 10/4, P = 4), 10/4, pch = 16, col = "black", cex = 1.5)
points(BRFXi(Xj = 10/4, P = 4), BRFXi(Xj = BRFXi(Xj = 10/4, P = 4), P = 4), pch = 16, col = "black", cex = 1.5)
points(BRFXi(Xj = BRFXi(Xj = BRFXi(Xj = 10/4, P = 4), P = 4), P = 4), BRFXi(Xj = BRFXi(Xj = 10/4, P = 4), P = 4),  pch = 16, col = "black", cex = 1.5)

text(BRFXi(Xj = 10/4, P = 4) + 0.2, 10/4, expression(paste(f)), cex = labelsize)
text(BRFXi(Xj = 10/4, P = 4) - 0.1, BRFXi(Xj = BRFXi(Xj = 10/4, P = 4), P = 4) + 0.2, expression(paste(g)), cex = labelsize)
text(BRFXi(Xj = BRFXi(Xj = BRFXi(Xj = 10/4, P = 4), P = 4), P = 4) + 0.2, BRFXi(Xj = BRFXi(Xj = 10/4, P = 4), P = 4) - 0.1, expression(paste(h)), cex = labelsize)
