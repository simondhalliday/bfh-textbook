...
library(shape)
pdf(file = "constrained_optimization/dictator_core_exam.pdf", width = 8, height = 8)
...
text(10.5, 1.4, expression(u[2]^A), cex = labelsize)
text(10.5, 2.1, expression(u[3]^A), cex = labelsize)
text(10.5, 3.6, expression(u[4]^A), cex = labelsize)
text(10.5, 0.6, expression(u[1]^A), cex = labelsize)
text(10.5, 10.3, expression(u[5]^A), cex = labelsize)
...
text(2.3+0.2, ppf(2.3) + 0.2, expression(paste(f)), cex = labelsize)
...
text(7.7+0.2, ppf(7.7) + 0.2, expression(paste(e)), cex = labelsize)
...
segments(0, 10, xlims[2], 10, lty = 1, col = COLB[3], lwd = graphlinewidth)
segments(10, 0, 10, ylims[2], lty = 1, col = COLB[3], lwd = graphlinewidth)


text(10.2, 0.2, expression(paste(g)), cex = labelsize)
...
text(0.2, 10.2, expression(paste(h)), cex = labelsize)
# segments(7, 0, 7, ppf(x = 7), lty = 2, col = "gray", lwd = segmentlinewidth)
# segments(0, ppf(x = 7), 7, ppf(x = 7), lty = 2, col = "gray", lwd = segmentlinewidth)
points(0, 10, pch = 16, col = "black", cex = 1.5, xpd = NA)
