require(shape)
pdf(file = "people/sequential_palanpur_solved_v2.pdf", width = 9, height = 7)
...
text(6.9, 7.5, expression(paste("Plant")), cex = actionlabelsize, col = rgb(0, 0, 0, fadelevel))
text(6.9, 7.1, expression(paste("late")), cex = actionlabelsize, col = rgb(0, 0, 0, fadelevel))
...
text(8, 5, expression(paste("Bina")), cex = labelsize, col = rgb(0,0,0,fadelevel))
...
text(8.7, 3.5, expression(paste("Plant")), cex = actionlabelsize, col = rgb(0,0,0,fadelevel))
text(8.7, 3.1, expression(paste("late")), cex = actionlabelsize, col = rgb(0,0,0,fadelevel))

#Payoffs 

text(1, .6, expression("(" * phantom("4") * "," * phantom("4") * ")"), cex = actionlabelsize)
text(1, .6, expression(phantom("(") * "4" * phantom(",") * phantom("4") * phantom(")")), col = rgb(0, 0, 1, 1),  cex = actionlabelsize)
text(1, .6, expression(phantom("(") * phantom("4") * phantom(",") * "4" * phantom(")")), col = rgb(1, 0, 0, 1), cex = actionlabelsize)

text(4, .6, expression("(" * phantom("0") * "," * phantom("3") * ")"), cex = actionlabelsize,col = rgb(0,0,0,fadelevel))
text(4, .6, expression(phantom("(") * "0" * phantom(",") * phantom("3") * phantom(")")), col = rgb(0, 0, 1, 1,fadelevel),  cex = actionlabelsize)
text(4, .6, expression(phantom("(") * phantom("0") * phantom(",") * "3" * phantom(")")), col = rgb(1, 0, 0, 1,fadelevel), cex = actionlabelsize)

text(6, .6, expression("(" * phantom("3") * "," * phantom("0") * ")"), cex = actionlabelsize,col = rgb(0,0,0,fadelevel))
text(6, .6, expression(phantom("(") * "3" * phantom(",") * phantom("0") * phantom(")")), col = rgb(0, 0, 1, 1,fadelevel),  cex = actionlabelsize)
text(6, .6, expression(phantom("(") * phantom("3") * phantom(",") * "0" * phantom(")")), col = rgb(1, 0, 0, 1,fadelevel), cex = actionlabelsize)

text(9, .6, expression("(" * phantom("2") * "," * phantom("2") * ")"), cex = actionlabelsize, col = rgb(0,0,0,fadelevel))
text(9, .6, expression(phantom("(") * "2" * phantom(",") * phantom("2") * phantom(")")), col = rgb(0, 0, 1, 1,fadelevel),  cex = actionlabelsize)
text(9, .6, expression(phantom("(") * phantom("2") * phantom(",") * "2" * phantom(")")), col = rgb(1, 0, 0, 1,fadelevel), cex = actionlabelsize)
