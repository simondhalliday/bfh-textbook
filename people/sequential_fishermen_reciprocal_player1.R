require(shape)
pdf(file = "people/sequential_fishermen_reciprocal_player1.pdf", width = 9, height = 7)
...
#Payoffs 
text(2.5, 4.6, expression("(5, 5)"), cex = actionlabelsize)
text(7.5, 4.6, expression("(4, 4)"), cex = actionlabelsize)
