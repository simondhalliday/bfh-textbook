...
pdf(file = "specprodexch/leontief_techchange.pdf", width = 9, height = 7)
...
segments(4, 8, xlims[2], 8, lty = 1, col = COLB[4], lwd = graphlinewidth)
segments(4, 8, 4, ylims[2], lty = 1, col = COLB[4],  lwd = graphlinewidth)
