...
require(shape)
pdf(file = "firmmarketsupply/costs_eos.pdf", width = 9, height = 7)
...
lines(xx1, avgcost(xx1, c0 = 2, c1 = 2, c2 = -0.05), col = COL[1], lwd = graphlinewidth)
lines(xx1, avgvarcost(xx1, c1 = 2, c2 = -0.05), col = COL[2], lwd = graphlinewidth)
lines(xx1, marginalcost(xx1, c1 = 2, c2 = -0.05), col = COL[3], lwd = graphlinewidth)
