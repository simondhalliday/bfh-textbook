require(ggplot2)
require(shape)
pdf(file = "society/matrix_fishermen_general_liability.pdf", width = 9, height = 7)
...
P1BR2 <- c("NE") #Must be NE or SE - the BR prints accordingly. 
...
#P1
text(4.7, 0.5, P1Payoffs[2], cex = PayoffSize)
#P2
...
#P2
text(7.3, 3.5, P2Payoffs[3], cex = PayoffSize)
