...
text(0.5*xlims[2], -3.5, expression(paste("A's smoking")), xpd = TRUE, cex = axislabelsize) 
...
text(2.3, 11.5, expression(paste(u[A],"(",x[A],",",x[B0],")")), xpd = TRUE, cex = labelsize) 
...
text(5.6, 5, expression(paste("Price")), cex = labelsize)
text(5.6, 4.3, expression(paste("before tax")), cex = labelsize, xpd = TRUE)
