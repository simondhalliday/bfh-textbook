...
text(-0.3, 1.25,  expression(paste(x[Bt]^N)), xpd=TRUE, cex=axislabelsize)
#text(-0.3, 2.5, expression(paste(frac(alpha,P[0]))), xpd=TRUE, cex=axislabelsize )
text(-0.3, 5, expression(paste(x[B0]^N)), xpd = TRUE, cex = labelsize)
text(2, -0.49, expression(paste(x[At]^{direct})) , xpd=TRUE, cex=labelsize)
text(5, -0.49, expression(paste(x[A0]^N)), xpd=TRUE, cex=labelsize )
text(1.25, -0.49, expression(paste(x[At]^N)), xpd=TRUE, cex=labelsize )
...
text(1.25, 7.3, expression(paste("A's best-response")), cex = labelsize)
text(1.25, 7, expression(paste("after tax")), cex = labelsize)
text(4.95, 7.3, expression(paste("A's best-response")), cex = labelsize)
text(4.95, 7, expression(paste("before tax")), cex = labelsize)

text(7.1, 5.3, expression(paste("B's best-response")), cex = labelsize, xpd = TRUE)
text(7.1, 5.0, expression(paste("before tax")), cex = labelsize, xpd = TRUE)
text(7.1, 2, expression(paste("B's best-response")), cex = labelsize, xpd = TRUE)
text(7.1, 1.7, expression(paste("after tax")), cex = labelsize, xpd = TRUE)
