require(ggplot2)
require(shape)
pdf(file = "/Users/shalliday/Google Drive/Smith/ECO250-Intermediate/Exams/Final/S2016/fig_final.pdf", width = 9, height = 7)
...
xx7 <- seq(14.14214, xlims[2], length.out = npts2)
xx8 <- seq(14.14214, 15, length.out = npts2)
...
lines(xx2, solowCondition(xx2, delta = 3.4), col = COL[3], lwd = 2, lty = 2)
lines(xx2, solowCondition(xx2, delta = 4.5), col = COL[3], lwd = 2, lty = 2)
lines(xx5, isovhigh1(xx5, v = 30, delta = 5), col = COL[1], lwd = 2, lty = 2)
lines(xx6, isovlow1(xx6, v = 30, delta = 5), col = COL[1], lwd = 2, lty = 2)
lines(xx7, isovhigh(xx7, v = 10, delta = 5), col = COL[1], lwd = 2, lty = 2)
lines(xx8, isovlow(xx8, v = 10, delta = 5), col = COL[1], lwd = 2, lty = 2)
...
text(38, 0.98, expression(paste(pi[1])))
text(34, 0.98, expression(paste(pi[2])))
text(25, 0.98, expression(paste(pi[3])))
...
text(26.5, 0.05, expression(paste("v = ", v[2])))
# text(36, 0.1, expression(paste("Iso-v curve")))
text(36, 0.05, expression(paste("v = ", v[3])))
# text(36, 0.1, expression(paste("Iso-v curve")))
text(16.2, 0.05, expression(paste("v = ", v[1])))
...
text(20.6, solowCondition(20, delta = 5) - 0.01, expression(paste("n")))

points(17, solowCondition(17, delta = 3.4), pch = 16, col = "black", cex = 1.5) 
text(16.5, solowCondition(17, delta = 3.4) + 0.02, expression(paste("g")))
