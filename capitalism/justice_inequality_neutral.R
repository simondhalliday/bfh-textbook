...
avgwealth <- function(delta, a = 0.25, b = 2, c = 0.25){
  a + b*delta - c*delta^2
}
...
text(b/(2*c), avgwealth(delta = b/(2*c)) +1, expression(paste(m)), cex = labelsize)
...
text((b - 0.5)/(2*c), avgwealth(delta = (b - 0.5)/(2*c)) + 1, expression(paste(P)), cex = labelsize)
...
points((b + 0.5)/(2*c), avgwealth(delta = (b + 0.5)/(2*c)), pch = 16, col = "black", cex = 1.5)
text((b + 0.5)/(2*c), avgwealth(delta = (b + 0.5)/(2*c)) + 1, expression(paste(R)), cex = labelsize)
