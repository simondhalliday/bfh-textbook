...
text(40, cbc1(39)+1.1, expression(paste("e"[sub])), cex = labelsize)
...
text(57, bc2(56)+1.1, expression(paste("e")), cex = labelsize)
segments(56, 0, 56, bc2(x = 56), lty = 2, col = "gray", lwd = segmentlinewidth)
segments(0, bc2(x = 56), 56, bc2(x = 56), lty = 2, col = "gray", lwd = segmentlinewidth)
points(56, bc2(x = 56), pch = 16, col = "black", cex = 1.5)

text(40.2, bc1(39)+1.2, expression(paste("e'")), cex = labelsize)
