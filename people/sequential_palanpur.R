require(shape)
pdf(file = "people/sequential_palanpur.pdf", width = 9, height = 7)
...
text(3.7, 3.5, expression(paste("Plant")), cex = actionlabelsize)
text(3.7, 3.1, expression(paste("late")), cex = actionlabelsize)


text(8, 5, expression(paste("Bina")), cex = labelsize)
text(6.3, 3.5, expression(paste("Plant")), cex = actionlabelsize)
...
text(4, .6, expression(phantom("(") * "0" * phantom(",") * phantom("3") * phantom(")")), col = rgb(0, 0, 1, 1),  cex = actionlabelsize)
text(4, .6, expression(phantom("(") * phantom("0") * phantom(",") * "3" * phantom(")")), col = rgb(1, 0, 0, 1), cex = actionlabelsize)

text(6, .6, expression("(" * phantom("3") * "," * phantom("0") * ")"), cex = actionlabelsize)
text(6, .6, expression(phantom("(") * "3" * phantom(",") * phantom("0") * phantom(")")), col = rgb(0, 0, 1, 1),  cex = actionlabelsize)
text(6, .6, expression(phantom("(") * phantom("3") * phantom(",") * "0" * phantom(")")), col = rgb(1, 0, 0, 1), cex = actionlabelsize)

text(9, .6, expression("(" * phantom("2") * "," * phantom("2") * ")"), cex = actionlabelsize)
text(9, .6, expression(phantom("(") * "2" * phantom(",") * phantom("2") * phantom(")")), col = rgb(0, 0, 1, 1),  cex = actionlabelsize)
text(9, .6, expression(phantom("(") * phantom("2") * phantom(",") * "2" * phantom(")")), col = rgb(1, 0, 0, 1), cex = actionlabelsize)
