require(shape)
pdf(file = "what_can_markets_do/sequential_coase_unrestricted.pdf", width = 9, height = 7)
...
text(3, 7.1, expression(paste("(to restrict)")), cex = actionlabelsize)
...
text(1.1, 3.5, expression(paste("Accept")), cex = actionlabelsize)
text(1.1, 3.1, expression(paste("(Restrict)")), cex = actionlabelsize)
...
text(3.8, 3.1, expression(paste("(Use)")), cex = actionlabelsize, col = rgb(0,0,0,fadelevel))
...
text(8.7, 3.5, expression(paste("Use")), cex = actionlabelsize, col = rgb(0,0,0,fadelevel))
...
text(4, .6, expression("(" * phantom("1") * "," * phantom("5") * ")"), cex = actionlabelsize)
text(4, .6, expression(phantom("(") * "1" * phantom(",") * phantom("5") * phantom(")")), col = rgb(0, 0, 1, 1 ,fadelevel),  cex = actionlabelsize)
text(4, .6, expression(phantom("(") * phantom("1") * phantom(",") * "5" * phantom(")")), col = rgb(1, 0, 0, 1 ,fadelevel), cex = actionlabelsize)

text(6, .6, expression("(" * phantom("4") * "," * phantom("4") * ")"), cex = actionlabelsize)
text(6, .6, expression(phantom("(") * "4" * phantom(",") * phantom("4") * phantom(")")), col = rgb(0, 0, 1, 1 ,fadelevel),  cex = actionlabelsize)
text(6, .6, expression(phantom("(") * phantom("4") * phantom(",") * "4" * phantom(")")), col = rgb(1, 0, 0, 1 ,fadelevel), cex = actionlabelsize)
