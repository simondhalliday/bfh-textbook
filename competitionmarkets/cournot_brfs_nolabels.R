require(shape)
#pdf(file = "competitionmarkets/cournot_brfs_nolabels.pdf", width = 9, height = 7)
jpeg(file = "cournot_brfs_nolabels.jpg", width = 6*120, height = 4*120)
...
# text(34, 29, expression(paste(x^A == x^B)), cex = labelsize)
# 

# #B's brf
# text(31.5, 8, expression(paste("B's best-response")), cex = annotatesize)
# text(31.5, 6, expression(paste("function")), cex = annotatesize)
