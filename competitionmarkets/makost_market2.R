...
segments(1, 2, 2, 2, lty = 1, col = CBCols[1] , lwd = graphlinewidth)
segments(1, 2, 1, 3, lty = 1, col = CBCols[1] , lwd = graphlinewidth)
segments(2, 2, 2, 0, lty = 1, col = CBCols[1] , lwd = graphlinewidth)
...
#For market price
segments(0, 2, 1, 2, lty = 2, grays[20] , lwd = graphlinewidth)
