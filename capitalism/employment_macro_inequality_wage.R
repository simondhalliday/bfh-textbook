...
require(plotrix)
require(pBrackets)
pdf(file = "capitalism/employment_macro_inequality_wage.pdf", width = 9, height = 7)
...
text(0.8 - 0.015, WageFn(0.8) + 1.25, expression(paste(n)), cex = labelsize)


brackets(x1 = 0.795, y1 = -3.5, x2 = 0, y2 = -3.5,  
         ticks = 0.5, curvature = 0.5, type = 1, h = 1,  
         col = "black", lwd = 2, lty = 1, xpd = TRUE)
text(0.4, -5.7, expression(paste("employed, n")), xpd = TRUE, cex = labelsize)

brackets(x1 = 0.895, y1 = -3.5, x2 = 0.805, y2 = -3.5,  
         ticks = 0.5, curvature = 0.5, type = 1, h = 1,
         col = "black", lwd = 2, lty = 1, xpd = TRUE)
text(0.85, -5.7, expression(paste("unemployed, u")), xpd = TRUE, cex = labelsize)
...
text(1, WageFn(0.8) + 1.3, expression(paste("the wage, ", w^c)), cex = labelsize, xpd = TRUE)
