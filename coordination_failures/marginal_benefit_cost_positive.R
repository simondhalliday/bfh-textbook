require(shape)
pdf(file = "coordination_failures/marginal_benefit_cost_positive.pdf", width = 9, height = 7)
...
MBenefit <- function(ea, eb = 12, alpha = 2, beta = -0.25) {
...
text(x = c(0, 12, 15, 24, xlims[2]), par("usr")[3] - 0.4, labels = xlabels, srt = 0, pos = 1, xpd = TRUE)
...
text(24, 12, expression(paste("when, ", h^B > 0 )), cex = labelsize)
