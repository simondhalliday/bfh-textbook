...
require(shape)
pdf(file = "competitionmarkets/monopolist_competition_comp.pdf", width = 9, height = 7)
...
text(32, 9, expression(paste("Consumer surplus")), cex = labelsize)
text(32, 8, expression(paste("gained from bargain")), cex = labelsize)
Arrows(30.4, 7.5, 26, 5, col = "black", lty = 1, lwd = 2, arr.type = "triangle", arr.lwd = 0.5)


#Labels cost and profit areas
text(9, 1, expression("Total costs"), cex = labelsize)
text(9, 5, expression("Compensation"), cex = labelsize)
