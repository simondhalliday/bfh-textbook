...
text(1, .6, expression(phantom("(") * "4.5" * phantom(",") * phantom("1.5") * phantom(")")), col = rgb(1, 0, 0, 1),  cex = actionlabelsize)
text(1, .6, expression(phantom("(") * phantom("4.5") * phantom(",") * "1.5" * phantom(")")), col = rgb(0, 0, 1, 1), cex = actionlabelsize)
