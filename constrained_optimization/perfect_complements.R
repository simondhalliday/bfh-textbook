require(shape)
pdf(file = "bfh-textbook/constrained_optimization/perfect_complements.pdf", width = 9, height = 7)
...
mtext(expression(paste("Quantity of Right Shoes, ", x)), side=1, line = 2.5, cex = axislabelsize)
text(-0.8, 0.5*ylims[2], expression(paste("Quanity of Left Shoes, ", y)), xpd = TRUE, cex = axislabelsize, srt = 90) 
...
text(9.8, 1.7, expression(u[1]), cex = labelsize)
text(9.8, 3.7, expression(u[2]), cex = labelsize)
text(9.8, 5.7, expression(u[3]), cex = labelsize)
