...
require(shape)
pdf(file = "bfh-textbook/constrained_optimization/constrained_optimization_hg_selfish.pdf", width = 9, height = 7)
...
lines(xx1, indiffcurveHG(xx1, v = 10 - 4, lambda = 0), col = COLA[2], lwd = 4)
lines(xx1, indiffcurveHG(xx1, v = 10, lambda = 0), col = COLA[2], lwd = 4)
lines(xx1, indiffcurveHG(xx1, v = 10 + 4, lambda = 0), col = COLA[2], lwd = 4)
...
text(14, 5.5, expression(v[1]^A))
text(14, 9.5, expression(v[2]^A))
text(14, 13.5, expression(v[3]^A))
...
text(12, 11.5, expression(paste("for ", lambda == 0)), cex = axislabelsize)
