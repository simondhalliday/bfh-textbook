require(ggplot2)
require(shape)
pdf(file = "society/matrix_disagreement_improve.pdf", width = 9, height = 7)
...
P1Name <- c("Aisha")
P1Strat <- c("Stick to", "Improve")
P1Strat2 <- c("Swahili", "English")
P1Payoffs <- c("4", "1", "0", "2")
...
P2Name <- c("Ben")
P2Strat <- c("Improve", "Stick to")
P2Strat2 <- c("Swahili", "English")
P2Payoffs <- c("2", "1", "0", "4")
