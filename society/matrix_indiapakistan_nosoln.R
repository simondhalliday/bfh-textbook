require(ggplot2)
require(shape)
pdf(file = "society/matrix_indiapakistan_nosoln.pdf", width = 9, height = 7)
...
P1Name <- c("India")
P1Strat <- c("Disarm", "Escalate")
P1Payoffs <- c("0", "5", "-10", "-5")
...
P2Name <- c("Pakistan")
P2Strat <- c("Disarm", "Escalate")
P2Payoffs <- c("0", "-10", "5", "-5")
