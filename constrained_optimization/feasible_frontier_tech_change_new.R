...
ypoly2 <- ppf(xpoly2, bary = 5, slope = 5/256)
...
ypoly1 <- ppf(xpoly1, bary = 4, slope = 1/64)
polygon(x = c(xpoly1, xpoly1[1]), y = c(ypoly1, rev(ypoly1)[1]), col=COLA[1], density=NULL, border = NA)


#Draw the graphs
lines(xx1, ppf(xx1), col = COLA[4], lwd = graphlinewidth)
lines(xx1, ppf(xx1, bary = 5, slope = 5/256), col = COLA[5], lwd = graphlinewidth)
...
text(10.5, 0.7, expression("Initial"), cex = labelsize)
text(10.5, 0.5, expression("Feasible Frontier"), cex = labelsize)
text(10.5, 0.3, expression(paste((ff[1]))), cex = labelsize)
Arrows(12.5, 0.5, 14.4, 0.5, col = "black", lty = 1, lwd = 2, arr.type = "triangle", arr.lwd = 0.5)

#Axis labels
mtext(expression(paste("Living (hours), ", x)), side = 1, line = 2.5, cex = axislabelsize)
text(-1.3, 0.5*ylims[2], expression(paste("Learning, ", y)), xpd = TRUE, cex = axislabelsize, srt = 90) 


#Annotate max u point on feasibility frontier
text(8.4, ppf(8) + 0.1, expression(paste(a)), cex = labelsize)
segments(8, 0, 8, ppf(x = 8, slope = 5/256), lty = 2, col = "gray", lwd = segmentlinewidth)
segments(0, ppf(x = 8), 8, ppf(x = 8), lty = 2, col = "gray", lwd = segmentlinewidth)
points(8, ppf(x = 8), pch = 16, col = "black", cex = 1.5)

text(8.4, ppf(x = 8, bary = 5, slope = 5/256) + 0.1, expression(paste(d)), cex = labelsize)
segments(0, ppf(x = 8, bary = 5, slope = 5/256), 8, ppf(x = 8, k = 4/log(17)), lty = 2, col = "gray", lwd = segmentlinewidth)
points(8, ppf(x = 8, bary = 5, slope = 5/256), pch = 16, col = "black", cex = 1.5)
...
text(13.85641-0.3, ppf(13.85641) - 0.1, expression(paste(g)), cex = labelsize)
segments(13.85641, 0, 13.85641, ppf(x = 13.85641), lty = 2, col = "gray", lwd = segmentlinewidth)
segments(0, ppf(x = 13.85641), 13.85641, ppf(x = 13.85641), lty = 2, col = "gray", lwd = segmentlinewidth)
points(13.85641, ppf(x = 13.85641), pch = 16, col = "black", cex = 1.5)

#Point for c
points(8, 1, pch = 16, col = "black", cex = 1.5)

Arrows(6, ppf(x = 6) + 0.1, 6, ppf(x = 6, bary = 5, slope = 5/256) - 0.1, col = "black", lty = 2, lwd = 2, arr.type = "triangle", arr.lwd = 0.5)
text(4.5, 4.2, expression("Increased"), cex = labelsize)
text(4.5, 4, expression("Productivity"), cex = labelsize)


#Label the feasible frontier
text(10.5, 4.45, expression("Increased Productivity"), cex = labelsize)
text(10.5, 4.25, expression("Feasible Frontier"), cex = labelsize)
text(10.5, 4.05, expression(paste((ff[2]))), cex = labelsize)
Arrows(10.5, 3.95, 10.5, 3, col = "black", lty = 1, lwd = 2, arr.type = "triangle", arr.lwd = 0.5)
