require(shape)
pdf(file = "competitionmarkets/demand_supply_core_exam.pdf", width = 9, height = 7)
...
text(86, Demand(86, rmax = 22, xmax = 14) + 0.75, expression(paste(2)), cex = axislabelsize) 
...
text(23, 13.7, expression(paste("Demand before")), cex = labelsize)
text(126, 4.2, expression(paste("Demand after")), cex = labelsize)
