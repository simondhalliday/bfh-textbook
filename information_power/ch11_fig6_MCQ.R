require(ggplot2)
require(shape)
#pdf(file = "information_power/ch11_fig6_MCQ.pdf", width = 9, height = 7)
jpeg(file = "information_power/ch11_fig6_MCQ.jpg", width = 5*120, height = 4*120)
...
xx7 <- seq(17, xlims[2], length.out = npts2)
xx8 <- seq(17, 20, length.out = npts2)
xx9 <- seq(20, xlims[2], length.out = npts2)
xx10 <- seq(20, 40, length.out = npts2)
...
lines(xx3, isovhigh(xx3, v = 20, delta = 5), col = CBCols[1], lwd = graphlinewidth, lty = 2)
lines(xx4, isovlow(xx4, v = 20, delta = 5), col = CBCols[1], lwd = graphlinewidth, lty = 2)
lines(xx2, solowCondition(xx2, delta = 5), col = CBCols[2], lwd = graphlinewidth)
lines(xx2, solowCondition(xx2, delta = 4.54), col = CBCols[2], lwd = graphlinewidth)
lines(xx2, solowCondition(xx2, delta = 5.85), col = CBCols[2], lwd = graphlinewidth)
...
lines(xx7, isovhigh(xx7, v = 15, delta = 5), col = CBCols[1], lwd = graphlinewidth, lty = 2)
lines(xx8, isovlow(xx8, v = 15, delta = 5), col = CBCols[1], lwd = graphlinewidth, lty = 2)
lines(xx9, isovhigh1(xx9, v = 40, delta = 5), col = CBCols[1], lwd = graphlinewidth, lty = 2)
lines(xx10, isovlow1(xx10, v = 40, delta = 5), col = CBCols[1], lwd = graphlinewidth, lty = 2)
...
points(20.3, 0.43, pch = 16, col = "black", cex = 1.5)
text(21.2, 0.41, expression(paste("m")), cex = annotatesize)

points(20.1, 0.55, pch = 16, col = "black", cex = 1.5)
text(19, 0.56, expression(paste("l")), cex = annotatesize)
...
points(24.8, 0.53, pch = 16, col = "black", cex = 1.5)
text(25.6, 0.52, expression(paste("g")), cex = annotatesize)

points(30, 0.75, pch = 16, col = "black", cex = 1.5)
text(31, 0.73, expression(paste("h")), cex = annotatesize)
