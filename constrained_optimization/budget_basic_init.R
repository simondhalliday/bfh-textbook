require(shape)
pdf(file = "constrained_optimization/budget_basic_init.pdf", width = 9, height = 7)
...
ylabels <- c(NA, expression(paste(y == m )), NA)
...
text(11, 2.6, expression(paste(y == m - p%.%x)), cex = annotatesize)
