...
jpeg(file = "information_power/ch11_fig5_blank.jpg", width = 6*120, height = 4*120)
...
lines(xx2, solowCondition(xx2, delta = 5), lty = 2, col = CBCols[2], lwd = segmentlinewidth)
...
segments(0, 0, 20, 1, lty = 2, lwd = segmentlinewidth, col = CBCols[2])
# points(10, 0.5, pch = 16, col = "black", cex = 1.5)
# text(9.6, 0.53, expression(paste("c")), cex = annotatesize)

#Add a ray and a point for d. 
segments(0, 0, 40, 0.5, lty = 2, lwd = segmentlinewidth, col = CBCols[2])
