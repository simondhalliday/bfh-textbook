...
library(shape)
pdf(file = "constrained_optimization/feasible_dictator_problemset.pdf", width = 8, height = 8)
...
text(-2, 0.5*ylims[2], expression(paste("B's payoff (dollars), ", pi^B)), xpd = TRUE, cex = axislabelsize, srt = 90) 
...
text(2, 9.5, expression(ff[1]), cex = labelsize)
text(2, 19, expression(ff[2]), cex = labelsize)
text(2, 37.5, expression(ff[3]), cex = labelsize)

#Annotate max u point on feasible frontier
#text(5.2, ppf(5) + 0.2, expression(paste(i)), cex = labelsize)

segments(0, ppf(x = 16, bary = 10, slope = 0.5), 16, ppf(x = 16, bary = 10, slope = 0.5), lty = 2, col = "gray", lwd = segmentlinewidth)
segments(0, ppf(x = 16), 16, ppf(x = 16), lty = 2, col = "gray", lwd = segmentlinewidth)
segments(16, 0, 16, ppf(x = 16, bary = 40, slope = 2), lty = 2, col = "gray", lwd = segmentlinewidth)
segments(0, ppf(x = 16, bary = 40, slope = 2), 16, ppf(x = 16, bary = 40, slope = 2), lty = 2, col = "gray", lwd = segmentlinewidth)

points(16, ppf(x = 16, bary = 10, slope = 0.5), pch = 16, col = "black", cex = 1.5)
points(16, ppf(x = 16), pch = 16, col = "black", cex = 1.5)
points(16, ppf(x = 16, bary = 40, slope = 2), pch = 16, col = "black", cex = 1.5)
