require(ggplot2)
require(shape)
pdf(file = "specprodexch/matrix_eos_fish_shirts.pdf", width = 9, height = 7)
...
P1Name <- c("Player A")
P1Strat <- c("Shirts", "Fish")
P1Payoffs <- c("3.33", "2.5", "1.67", "2.5")
...
P2Name <- c("Player B")
P2Strat <- c("Shirts", "Fish")
P2Payoffs <- c("3.33", "1.67", "2.5", "2.5")
