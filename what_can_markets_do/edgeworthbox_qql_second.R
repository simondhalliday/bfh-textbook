...
lines(xx1, WalrasP(xx1, intercept = 8.5), col = "purple", lwd = segmentlinewidth)
...
text(4, 9.2, expression(slope == -p[w] ))
...
text(4.8, 3.3, expression(paste(n[0])))
...
#Initial Allocations
segments(8.15, 0, 8.15, 3.35, col = COL[2] , lwd = segmentlinewidth, lty = 2)
segments(xlims[2], 0.35, 8.15, 0.35, col = COL[2] , lwd = segmentlinewidth, lty = 2)
