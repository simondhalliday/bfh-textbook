...
Arrows(2.5, 5, 4, 1, col = rgb(1, 0, 0, 0.5), lty = 1, lwd = 3, arr.type = "triangle")
...
Arrows(5, 9, 7.5, 5, col = rgb(0, 0, 1, 0.5), lty = 1, lwd = 3, arr.type = "triangle")
...
#Payoffs 
text(1, .6, expression("(4, 2)"), cex = actionlabelsize, col = rgb(0,0,0,fadelevel))
text(4, .6, expression("(4, 4)"), cex = actionlabelsize)
text(6, .6, expression("(4, 4)"), cex = actionlabelsize)
