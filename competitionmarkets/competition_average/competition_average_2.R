...
text(9.5, 9, expression(paste("i")), cex = labelsize)
...
text(14.5, brfA(xbar = 14.1) + 0.2, expression(paste("h")), cex = labelsize)
...
text(14.7, 4.7, expression(paste("Isoprofit vertical")), cex = annotatesize)
text(14.7, 4, expression(paste("at intersection")), cex = annotatesize)
text(14.7, 3.3, expression(paste("with best response")), cex = annotatesize)
...
text(17, 14.5, expression(paste(x == bar(x))), cex = annotatesize)
text(17, 13.7, expression(paste("Typical firm's")), cex = annotatesize)
text(17, 12.9, expression(paste("output equals")), cex = annotatesize)
text(17, 12.1, expression(paste("average ouput")), cex = annotatesize)
text(17, 11.3, expression(paste("of other firms")), cex = annotatesize)


text(3.2, 13.2, expression(paste("Typical firm's")), cex = annotatesize)
text(3.2, 12.5, expression(paste("best response function")), cex = annotatesize)
Arrows(3, 13.6, 3, 16, col = "black", lty = 1, lwd = 2, arr.type = "triangle", arr.lwd = 0.5)
...
text(14, 18.5, expression("Typical firm's"), cex = annotatesize)
text(14, 17.8, expression("isoprofit curves"), cex = annotatesize)
text(14, 17.1, expression(paste(pi[3] > pi[2], phantom() > pi[1])), cex = annotatesize)
