...
library(shape)
pdf(file = "capitalism/workerwage_pref_wealth.pdf", width = 10, height = 8)
...
lines(xx1, pref(r = 14), col = COLA[4], lty = 1, lwd = graphlinewidth)
lines(xx1, pref(r = 18), col = COLA[4], lty = 2, lwd = graphlinewidth)
